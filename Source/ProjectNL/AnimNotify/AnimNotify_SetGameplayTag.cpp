...
#include "ProjectNL/AnimNotify/AnimNotify_SetGameplayTag.h"

#include "ProjectNL/Character/BaseCharacter.h"


void UAnimNotify_SetGameplayTag::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if (!AbilitySystemComponent->HasMatchingGameplayTag(TagToSet))
	{
		// Loose Gameplay Tag(임시 태그) 제거
		AbilitySystemComponent->SetLooseGameplayTagCount(TagToSet,1);
