...
namespace NlGameplayTags
{
	...
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Action)
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Block)
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Guard)
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_GuardReady)
	...
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Invincibile)
	// GC에 대한 Tag 정보
	...
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_EscMenu);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_RestartMenu);
