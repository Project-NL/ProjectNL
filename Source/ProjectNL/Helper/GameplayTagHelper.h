...
namespace NlGameplayTags
{
	...
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_SwordHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_SwordGaurdHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_HammerHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_HammerGaurdHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_DualBladeHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_DualBladeGaurdHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_AxeHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_AxeGaurdHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_LongSwordHit);
	PROJECTNL_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Particle_LongSwordGaurdHit);
