#include "EquipInventorySlotWidget.h"
...
void UEquipInventorySlotWidget::OnItemButtonPressed()
{
	// 현재 시간 가져오기
...
void UEquipInventorySlotWidget::EquipItem()
{
...
void UEquipInventorySlotWidget::NativeConstruct()
{
	...
	if (ItemButton)
	{
		ItemButton->OnPressed.AddDynamic(this, &UEquipInventorySlotWidget::OnItemButtonPressed);
	}
}
